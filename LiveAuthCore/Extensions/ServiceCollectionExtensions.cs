...
public static class ServiceCollectionExtensions
{
    ...
    public static WebApplicationBuilder AddLiveAuthServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IMeterCredentialService, MeterCredentialService>();
        builder.Services.AddScoped<IMeterReceiptService, MeterReceiptService>();
        builder.Services.AddScoped<IMeterAllowanceService, MeterAllowanceService>();
        builder.Services.AddScoped<IMeterPaymentService, MeterPaymentService>();
        builder.Services.AddScoped<IMeterOriginProxy, MeterOriginProxy>();
        builder.Services.AddScoped<ILightningInvoiceProvider, MerchantLndInvoiceProvider>();
        builder.Services.AddScoped<ILightningInvoiceProviderFactory, LightningInvoiceProviderFactory>();
